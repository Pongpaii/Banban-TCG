...
<div class="min-h-screen bg-white pb-20">
    ...
    <main class="max-w-md mx-auto px-4 py-6">
        ...
        <div class="p-6 mb-6 bg-gradient-to-r from-yellow-50 to-yellow-100 border-yellow-200 border-2 rounded-lg">
            <div class="text-center">
                ...
                <div class="flex items-center justify-center space-x-2">
                    <span class="text-3xl font-bold text-gray-800">฿{{ number_format($card['currentPrice']) }}</span>
        ...
        <!-- Back Button -->
        <div class="text-center">
            <a href="/" class="inline-flex items-center px-6 py-3 bg-yellow-400 hover:bg-yellow-500 text-gray-800 font-semibold rounded-xl">
...
// Price chart data
const priceData = [
    { date: "1/11", price: {{ $card['currentPrice'] - 50 }} },
    { date: "5/11", price: {{ $card['currentPrice'] - 30 }} },
    { date: "10/11", price: {{ $card['currentPrice'] - 10 }} },
    { date: "15/11", price: {{ $card['currentPrice'] - 20 }} },
    { date: "20/11", price: {{ $card['currentPrice'] + 10 }} },
    { date: "25/11", price: {{ $card['currentPrice'] }} },
    { date: "30/11", price: {{ $card['currentPrice'] }} },
];
